const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["js/BNm79z.js","js/BsD8YY.js","js/CSb5Uq.js"])))=>i.map(i=>d[i]);
import { c as createSignal, a as createComponent, b as createContext, u as useContext, i as invariant, r as render, d as createResource, e as createEffect, V as ViewportProvider, S as Switch, M as Match, f as Show, t as template, l as lazy } from "./BsD8YY.js";
...
const Desktop = lazy(async () => await __vitePreload(() => import("./BNm79z.js"), true ? __vite__mapDeps([0,1]) : void 0));
const Mobile = lazy(async () => await __vitePreload(() => import("./CSb5Uq.js"), true ? __vite__mapDeps([2,1]) : void 0));
function Main() {
