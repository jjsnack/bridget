const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["js/cQ6nev.js","js/C3xGhw.js","js/DsETc2.js","js/DleCmq.js","js/DZmA_U.js","js/BeFqNf.js"])))=>i.map(i=>d[i]);
...
} else if (page === "grid") __vitePreload(() => import("./BeFqNf.js").then((m) => {
	m.initGrid();
}), __vite__mapDeps([5,1]));
